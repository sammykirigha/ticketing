...
export default () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 h-[100vh] ">
            <div className="bg-[url('../../assets/background2.jpeg')] bg-cover flex justify-center">
                <div className="flex flex-col items-center justify-center  bg-slate-900 bg-opacity-70 px-2">
                    <h2 className="text-white text-2xl font-bold px-3">
                        Special Events
                    </h2>
                    <p className="text-white px-3 py-3 bg-slate-300 bg-opacity-25 text-2xl ">
                        We combine years of experience and technical experience
                        with a passion for theatre and concert touring. Our huge
                        state-of-the-art range covers lighting, sound and video
                        to staging, power, rigging and drapes, ensuring we’re
                        the perfect partner to supply kit for any kind of event.
                        Login to book your ticket to our varius events
                    </p>
                </div>
            </div>
            <div className="bg-gradient-to-r  from-violet-500 to-fuchsia-400  flex items-center justify-center py-8 px-8">
                <div className="block p-6 rounded-lg shadow-lg bg-white max-w-xl w-full">
                    <form onSubmit={onSubmit}>
                        <h3 className="text-gray-700 pb-3 text-2xl font-bold">
                            Sign Up
                        </h3>
...
// .intel-exhibitor-catalog .exhibitor-details-page .catalog-result .description span{
//   color: #000000;
// }

// .intel-exhibitor-catalog .exhibitor-details-page #exhibitor-sessions .session-details p{
//   color: black;
// }